...
//     product = getProductById("prod_drop_1");
//     if (product) return product;

//     var allProducts = getAllProducts();
//     return allProducts.length ? allProducts[0] : null;
//   }
...
//     // Fallback DOM heuristics for local servers or route rewrites.
...
//     if (document.getElementById("wishlist-total-num") || document.getElementById("page-wishlist-grid")) return "Wishlist";
//     if (document.getElementById("track-form") || document.getElementById("track-input")) return "TrackOrder";
//     if (document.getElementById("shop-all-grid")) return "Category";
...
//       // Keep MCP.items useful on PDP even if cart is empty.
//       if (!mcp.items.length) {
//         mcp.items = [
//           {
//             item_id: product.id,
...
//     var category = getCategoryFromPage() || document.body.getAttribute("data-page-gender");
//     if (detectedPageType === "Category") {
//       mcp.pageName = "Category";
//       mcp.pageType = "Category";
//       mcp.itemListId = category || "Category";
//       mcp.itemListName = getCategoryDisplayName(category || "Category");
//       return mcp;
//     }
...
//                   var fallbackProduct = getCurrentPdpProduct();
//                   return fallbackProduct && fallbackProduct.id ? fallbackProduct.id : null;
//                 },
//                 attributes: {
//                   sku: function () {
//                     var mcpSku = getDataLayerValue(["MCP", "Item", "sku"]);
//                     if (mcpSku) return mcpSku;
//                     var fallbackProduct = getCurrentPdpProduct();
//                     return fallbackProduct && fallbackProduct.id ? fallbackProduct.id : null;
//                   },
//                   name: function () {
...
//                 var fallbackProduct = getCurrentPdpProduct();
//                 var id = getDataLayerValue(["MCP", "Item", "id"]) || (fallbackProduct && fallbackProduct.id);
//                 var price = getDataLayerValue(["MCP", "Item", "price"]) || (fallbackProduct && parsePrice(fallbackProduct.saleNum || fallbackProduct.salePrice)) || 0;
//                 var name = getDataLayerValue(["MCP", "Item", "name"]) || (fallbackProduct && fallbackProduct.title) || "";
//                 if (!id) return;
